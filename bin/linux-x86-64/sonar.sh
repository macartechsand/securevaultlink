...
COMMAND_LINE="$JAVA_CMD $XMS $XMX $HAZELCAST_ADDITIONAL -jar $LIB_DIR/sonar-application-25.5.0.107428.jar"
    ...
    then
        ...
        then
            ...
            then
                ...
                pidtest=`$PSEXE -p $pid -o args -ww | grep "sonar-application-25.5.0.107428.jar" | tail -1`
                if [ "X$pidtest" = "X" ]
                then
...
forcestopit() {
    ...
    then
      ...
      ${JAVA_CMD} -jar "lib/sonar-shutdowner-25.5.0.107428.jar"
